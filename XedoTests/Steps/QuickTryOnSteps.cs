...
{
    [Binding]
    public sealed class QuickTryOnSteps : XedoStepBase
    {
        ...
        public void ThenTheAddressShouldBeSavedAsEntered()
        {
            ...
            Assert.IsTrue(savedAddress.Contains(CurrentContext.QuickTryOn.EnteredState) ||
                          savedAddress.Contains(CurrentContext.QuickTryOn.EnteredStateCode));
        ...
        {
            Assert.IsTrue(
                QuickTryOnPage.ErrorMessages.Any(l => l.Contains("Please enter the first line of your address")));
        }
        ...
        {
            Assert.IsTrue(QuickTryOnPage.ColourSelect.FirstSelectedColour.Name !=
                          QuickTryOnPage.ColourSelect.SecondSelectedColour.Name);
        }
