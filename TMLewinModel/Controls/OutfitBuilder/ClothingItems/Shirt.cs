...
{
    public class Shirt : ControlBase
    {
        private IWebElement _element;

        public Shirt(TestSettings testSettings, IWebElement element) : base(testSettings)
        {
            _element = element;
        }
        ...
        public class Locators
        {
            ...
            public static By Item = By.CssSelector("[data-at='lnk-shirt']");
        }
    }
}
