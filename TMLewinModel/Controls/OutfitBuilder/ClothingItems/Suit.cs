...
{
    public class Suit : ControlBase
    {
        private IWebElement _element;

        public Suit(TestSettings testSettings, IWebElement element) : base(testSettings)
        {
            _element = element;
        }
        ...
        public class Locators
        {
            ...
            public static By Item = By.CssSelector("[data-at='lnk-waistcoat']");
        }
    }
}
